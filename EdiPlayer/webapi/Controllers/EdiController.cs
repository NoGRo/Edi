...
namespace Edi.Controllers
{
    ...
    public class EdiController : ControllerBase
    {
        ...
        [HttpPost("LoadFile")]
        public async Task<IEnumerable<DefinitionGallery>> SelectFile([FromQuery]string path, [FromQuery] bool SeachForAssets = true) 
        {
            await _edi.LoadFile(path);
            return _edi.Definitions;
        }
