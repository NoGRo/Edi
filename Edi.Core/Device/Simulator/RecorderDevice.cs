...
namespace Edi.Core.Device.Simulator
{
    ...
    public class RecorderDevice : DeviceBase<FunscriptRepository, FunscriptGallery>, IRange
    {
            ...
            : base(repository, logger)
        {
            ...
            // Inicializa metadata con valores �tiles
        ...
        private void FlushToDisk()
        {
            ...
            try
            {
                ...
                {
                    // Solo la primera vez: leer el archivo y buscar el �ltimo elemento con regex
                ...
                // Escribir solo los nuevos actions en la posici�n guardada
                using (var fs = new FileStream(_outputFilePath, FileMode.Open, FileAccess.ReadWrite))
                {
                    ...
                    using (var writer = new StreamWriter(fs))
                    {
                        ...
                        {
                            // Leer el car�cter anterior para ver si es '[' o ',')
